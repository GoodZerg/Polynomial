  ...
  :Widget(size, name_window, components, main_window)
{
  ...
  // data base
  components->push_back(new TextField({ -1, -0.50 }, textfield_size, new std::vector <std::string*>{ new std::string("1") }));          // 0
  components->push_back(new TextField({ -1, -0.35 }, textfield_size, new std::vector <std::string*>{ new std::string("2") }));          // 1
  components->push_back(new TextField({ -1, -0.20 }, textfield_size, new std::vector <std::string*>{ new std::string("3") }));          // 2
  components->push_back(new TextField({ -1, -0.05 }, textfield_size, new std::vector <std::string*>{ new std::string("4") }));          // 3
  components->push_back(new TextField({ -1,  0.10 }, textfield_size, new std::vector <std::string*>{ new std::string("5") }));          // 4
  components->push_back(new TextField({ -1,  0.25 }, textfield_size, new std::vector <std::string*>{ new std::string("6") }));          // 5
  components->push_back(new TextField({ -1,  0.40 }, textfield_size, new std::vector <std::string*>{ new std::string("7") }));          // 6
  components->push_back(new TextField({ -1,  0.55 }, textfield_size, new std::vector <std::string*>{ new std::string("8") }));          // 7  
  components->push_back(new TextField({ -1,  0.70 }, textfield_size, new std::vector <std::string*>{ new std::string("9") }));          // 8
  components->push_back(new TextField({ -1,  0.85 }, textfield_size, new std::vector <std::string*>{ new std::string("10") }));         // 9
